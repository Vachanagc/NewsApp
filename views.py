...
def display_movies_information(request):
	...
	msg1 = 'RRR Trailer is launched!!!'
	msg2 = 'Robert by Dboss has been released last Year'
...
def display_sports_information(request):
	...
	msg2 = 'Virat Kohli got retired!! from Indian Cricket Team in some formats as Captain'
